...
├── opps_generator_standalone.py       # CLI v14 STANDALONE (XSD ugrađen)
├── opps_generator_gui_standalone.py   # GUI v14 STANDALONE (XSD ugrađen)
├── opps_generator_cli_v15.py          # CLI v15 STANDALONE (SQLite, CSV)
