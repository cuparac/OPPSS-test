"""OPPSS GENERATOR v14.0 GUI STANDALONE - XSD šema je ugrađena u kod.
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("OPPSS Generator v14.0 GUI STANDALONE - ePorezi prijava")
